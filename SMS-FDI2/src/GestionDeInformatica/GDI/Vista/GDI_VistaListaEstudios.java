	...
	public GDI_VistaListaEstudios() {
		...
		btnNuevoEstudio.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				dispose();
				FactoriaControlador.getInstancia().pantalla5(mod, plan,-1,arrayPlantillas);
			}
		});
		...
		arrayPlantillas = FactoriaControlador.getInstancia().leerListaEstudios(arrayPlantillas);
		...
		btnDelete.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(fila>-1) {
					...
					FactoriaControlador.getInstancia().eliminarEstudio(arrayPlantillas, fila);
					
					dispose();
					FactoriaControlador.getInstancia().pantalla2();
				}  
		...
		btnNewModificar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				mod=true;
				dispose();
				FactoriaControlador.getInstancia().pantalla5(mod,est,fila,arrayPlantillas);}
			}
		});
