...
public class GDI_VistaListaErrores extends JFrame {
	...
	public GDI_VistaListaErrores() {
		...
		FactoriaControlador.getInstancia().leerListaErrores(arrayErrores);
		...
		btnEliminar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(fila>-1) {
					FactoriaControlador.getInstancia().eliminarError(arrayErrores, fila);	
					dispose();
					FactoriaControlador.getInstancia().pantalla4();
					}
			}
		});
