...
public class SAPedido implements SAPedidos {
	...
	public PedidosDAO determinaFactoria(String type) {
		...
		if (type.equals("pedido_proyecto")) {
			...
			return FactoriaDAOPedidos.dameInstancia().generaPedidoProyectoDAO();
		}
		else if (type.equals("pedido_laboratorio")) {
			
			return FactoriaDAOPedidos.dameInstancia().generaPedidoLaboratorioDAO();
		}
		else if (type.equals("pedido_almacen")) {
			
			return FactoriaDAOPedidos.dameInstancia().generaPedidoAlmacenDAO();
		}
		else if (type.equals("pedido_inventario")) {
			
			return FactoriaDAOPedidos.dameInstancia().generaPedidoInventarioDAO();
		}
		else if (type.equals("pedido_envio")) {
			
			return FactoriaDAOPedidos.dameInstancia().generaPedidoEnvioDAO();
		}
		return null;
	}
