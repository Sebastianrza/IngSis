...
public class SAUsuario implements SAUsuarios {
	...
	public void insertarUsuario(UsuarioTransfer usuario) {
		...
		try {
			FactoriaDAOUsuario.dameInstancia().generaObjetoUsuarioDAO().insertarUsuario(usuario);
	...
	public void eliminaUsuario(UsuarioTransfer usuario) {
		...
		try {
			FactoriaDAOUsuario.dameInstancia().generaObjetoUsuarioDAO().eliminaUsuario(usuario);
	...
	public void modificaUsuario(UsuarioTransfer usuario) {
		...
		try {
			FactoriaDAOUsuario.dameInstancia().generaObjetoUsuarioDAO().modificarUsuario(usuario);
	...
	public UsuarioTransfer buscaUsuario(UsuarioTransfer usuario) {
		...
		try {
			return FactoriaDAOUsuario.dameInstancia().generaObjetoUsuarioDAO().buscarUsuario(usuario);
	...
	public List<UsuarioTransfer> solicitaUsuarios() {
		...
		try {
			...
			usuarios = FactoriaDAOUsuario.dameInstancia().generaObjetoUsuarioDAO().buscaListaUsuarios();
