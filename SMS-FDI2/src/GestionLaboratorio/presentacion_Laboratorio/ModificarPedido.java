...
public class ModificarPedido {
		...
		public ModificarPedido() {
		 ...
		 titulo= new JLabel("                    Modificar Pedido ");
		 ...
		 List<TransferProducto_Lab>lista=FactoriaControlador_Lab.getInstancia().listarPedido();
		 	
			infoPedido.append("Id_Pedido: "+FactoriaControlador_Lab.getInstancia().Id_Pedido()+"\n");
			infoPedido.append("Id_Solicitante: "+ FactoriaControlador_Lab.getInstancia().Id_Solicitante()+"\n");
			infoPedido.append("NombreSolicitante:: "+ FactoriaControlador_Lab.getInstancia().Id_NombreSolicitante()+"\n");
		 ...
		 confirmar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				FactoriaControlador_Lab.getInstancia().guardarPedido();
			}
		 ...
		 ok.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
					FactoriaControlador_Lab.getInstancia().addProducto(Integer.parseInt(id_codT.getText()), Integer.parseInt(cantT.getText()));
					List<TransferProducto_Lab>lista=FactoriaControlador_Lab.getInstancia().listarPedido();
					infoPedido.setText("Id_Pedido: "+FactoriaControlador_Lab.getInstancia().Id_Pedido()+"\n");
					infoPedido.append("Id_Solicitante: "+ FactoriaControlador_Lab.getInstancia().Id_Solicitante()+"\n");
					infoPedido.append("NombreSolicitante:: "+ FactoriaControlador_Lab.getInstancia().Id_NombreSolicitante()+"\n");
					for(int i =0;i<lista.size();i++) {
						infoPedido.append("  Id_Codigo: "+ lista.get(i).get_idProducto() +" Cantidad :" + lista.get(i).get_cantidad()+"\n");
		 ...
		 eliminar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try{
					FactoriaControlador_Lab.getInstancia().borrarProducto(Integer.parseInt(id_codT.getText()));
					List<TransferProducto_Lab>lista=FactoriaControlador_Lab.getInstancia().listarPedido();
					infoPedido.setText("Id_Pedido: "+FactoriaControlador_Lab.getInstancia().Id_Pedido()+"\n");
					for(int i =0;i<lista.size();i++) {
						infoPedido.append("  Id_Codigo: "+ lista.get(i).get_idProducto() +" Cantidad :" + lista.get(i).get_cantidad()+"\n");
