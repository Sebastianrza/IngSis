...
public class BuscarPedido extends JFrame{
	...
	private void initGUI() {
		 ...
		 superior = new JPanel(new BorderLayout());
		  titulo = new JLabel("                    Buscar Pedido ");
		 ...
		 ok.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					try{
						FactoriaControlador_Lab.getInstancia().BuscarPedido(id_codT.getText());
						FactoriaControlador_Lab.getInstancia().Demo();
						new ModificarPedido();
					}
