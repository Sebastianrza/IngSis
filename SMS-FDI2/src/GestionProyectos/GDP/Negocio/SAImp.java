...
public class SAImp implements SA{
	...
	public void EnviarPedido(PedidosTransfer pedido) {
		try {
			FactoriaDAOPedidos.dameInstancia().generaPedidoProyectoDAO().insertarPedido(pedido);
		} catch (FileNotFoundException e) {
			e.printStackTrace();
		}		
	}
	@Override
	public boolean proyectocontamano1(TPersona persona) {	
		return DAOProyectoImp.getInstancia().ProyectoConTamano1(persona);
	}
}
