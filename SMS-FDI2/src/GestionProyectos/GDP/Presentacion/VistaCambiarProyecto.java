			...
			public void actionPerformed(ActionEvent e) {
				if(getTabla().getSelectedRow()==-1) {
					...
					if(Controlador.getInstancia().cambiarproyecto(getPersonaSeleccionada(), getModelo().getProyecto(getTabla().getSelectedRow()))) {
						...
						if(Controlador.getInstancia().proyectocontamano1(getPersonaSeleccionada())) {
							JOptionPane.showMessageDialog(null, "No se ha podido cambiar de proyecto, m�nimo debe haber una persona trabajando en un proyecto");
						}
						else {
