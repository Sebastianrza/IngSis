		...
		fabricacion.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(getTabla().getSelectedRow()==-1) {
					...
					JOptionPane.showMessageDialog(null, "Selecciona un proyecto que no est� ya en fabricacion. ");
				}
				else {
				...
				continuar.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						if(tabla.getSelectedRow()==-1) {
							JOptionPane.showMessageDialog(null, "No has seleccionado ning�n participante del proyecto.");
						}
						else {
					...
					public void actionPerformed(ActionEvent e) {
						if(tabla.getSelectedRow()==-1) {
							...
							if(Controlador.getInstancia().liberar(modelo.getPersona(tabla.getSelectedRow()))) {
								...
								JOptionPane.showMessageDialog(null, "No se puede eliminar este participante puesto que es el �ltimo del proyecto, y un proyecto debe tener al menos uno");
							}
						}
