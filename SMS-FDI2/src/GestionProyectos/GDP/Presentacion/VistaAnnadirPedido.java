		...
		anadir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!idtexto.getText().equals("") && !nametexto.getText().equals("") && !cantexto.getText().equals("") && !productotexto.getText().equals("")) {
					try {
						TransferPedidoImp ped= new TransferPedidoImp();
					...
					JOptionPane.showMessageDialog(null, "Es necesario rellenar los 4 campos, para a�adir el producto");
				}				
			}
