...
public class EliminarEnvioMedico extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EliminarEnvioMedico frame = new EliminarEnvioMedico();
	 ...
	 */
	public EliminarEnvioMedico() throws FileNotFoundException {
		...
		setTitle("Eliminar Envio Medico");
